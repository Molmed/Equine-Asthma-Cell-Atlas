...
scConf_fullobj = modColours(scConf_fullobj, meta.to.mod = "Asthma phenotype", new.colours= c("#ffadad", "#ffd6a5", "#fdffb6", "#caffbf", "#9bf6ff", "#a0c4ff"))
...
scConf_tcellsobj = modColours(scConf_tcellsobj, meta.to.mod = "Asthma phenotype", new.colours= c("#ffadad", "#ffd6a5", "#fdffb6", "#caffbf", "#9bf6ff", "#a0c4ff"))
print("Making shiny files, selecting default genes to show")
...
print("Changing default plot colors")
scConf_macrophagesobj = modColours(scConf_macrophagesobj, meta.to.mod = "Clusters res.0.3", new.colours= c("#ffeaff", "#e9d5ff", "#d3c1ff", "#bcadff", "#a69aff", "#9087ff", "#7a74ff", "#6262ff", "#4951f0", "#2c40db", "#132be1"))
scConf_macrophagesobj = modColours(scConf_macrophagesobj, meta.to.mod = "Asthma phenotype", new.colours= c("#ffadad", "#ffd6a5", "#fdffb6", "#caffbf", "#9bf6ff", "#a0c4ff"))
print("Making shiny files, selecting default genes to show")
...
scConf_dendriticobj = modColours(scConf_dendriticobj, meta.to.mod = "Asthma phenotype", new.colours= c("#ffadad", "#ffd6a5", "#fdffb6", "#caffbf", "#9bf6ff", "#a0c4ff"))
print("Making shiny files, selecting default genes to show")
...
scConf_neutrophilsobj = modColours(scConf_neutrophilsobj, meta.to.mod = "Asthma phenotype", new.colours= c("#ffadad", "#ffd6a5", "#fdffb6", "#caffbf", "#9bf6ff", "#a0c4ff"))
print("Making shiny files, selecting default genes to show")
...
scConf_mastcellsobj = modColours(scConf_mastcellsobj, meta.to.mod = "Asthma phenotype", new.colours= c("#ffadad", "#ffd6a5", "#fdffb6", "#caffbf", "#9bf6ff", "#a0c4ff"))
print("Making shiny files, selecting default genes to show")
